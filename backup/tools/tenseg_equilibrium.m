function [Force_den,Support_Load] = tenseg_equilibrium(tenseg_struct, force_density_min)
% 
...
Force_den = linprog(ones(1,size(C_s,1)+size(C_b,1)),[],[],K1,zeros(size(W_vec)),force_density_min*ones(1,size(C_s,1)),[],options);
