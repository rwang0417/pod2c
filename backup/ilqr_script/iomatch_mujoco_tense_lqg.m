...
PERT_COEF = 0.4;
X_INIT = zeros(SYS_NUM,1);
Ck=[eye(6) zeros(6,144);zeros(6,24) eye(6) zeros(6,120);zeros(6,48) eye(6) zeros(6,96);zeros(6,69) eye(6) zeros(6,75)];%[eye(POS_NUM) zeros(VEL_NUM,VEL_NUM)];%[eye(6) zeros(6,144);zeros(6,50) eye(6) zeros(6,94);zeros(6,100) eye(6) zeros(6,44);zeros(6,144) eye(6)];%[eye(3) zeros(3,147);zeros(3,28) eye(3) zeros(3,119);zeros(3,56) eye(3) zeros(3,91);zeros(3,84) eye(3) zeros(3,63);zeros(3,112) eye(3) zeros(3,35);zeros(3,147) eye(3)];%eye(SYS_NUM);%
...
vk = .000*randn(OUT_NUM,STEP_NUM+1,TEST_NUM);
